...
import 'package:wahg_v1/features/presentation/pages/3_details_page/details_page.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case MakeupArtistDetailsPageScreen.id:
        {
          return MaterialPageRoute(builder: (_) => MakeupArtistDetailsPageScreen());
        }

      case DetailsPageScreen.id:
        {
          return MaterialPageRoute(builder: (_) => DetailsPageScreen());
        }
