...
import 'package:wahg_v1/features/presentation/ui_models/hp_hall_card_im.dart';
import 'package:wahg_v1/features/presentation/ui_models/hp_recommended_im.dart';
import 'package:wahg_v1/features/presentation/ui_models/jo_job_card_im.dart';
...
List<HPServiceCardIM> getHPServices() {
  return [
    HPServiceCardIM(
      menuImage: ImageAsset.imgRectangle6445,
      menuText: "Food Menu",
      subText: "Pending",
      pendingImage: ImageAsset.imgVideoCamera,
    ),
    HPServiceCardIM(
      menuImage: ImageAsset.imgRectangle6446,
      menuText: "Guest List",
      subText: "Completed",
      pendingImage: ImageAsset.imgAkarIconsCircleCheckFill,
    ),
    HPServiceCardIM(
      menuImage: ImageAsset.imgRectangle6447,
      menuText: "Vendor Shortlist",
      subText: "Pending",
      pendingImage: ImageAsset.imgVideoCamera,
    )
  ];
...
List<HPRecommendedIM> getHPRecommended() {
  return [
    HPRecommendedIM(
      image: ImageAsset.imgImage604,
      text: 'Item 1',
    ),
    HPRecommendedIM(
      image: ImageAsset.imgRectangle6394,
      text: 'Item 2',
    )
  ];
}
