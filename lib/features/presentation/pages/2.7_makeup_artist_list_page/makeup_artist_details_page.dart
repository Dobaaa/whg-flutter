...
class MakeupArtistDetailsPageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MakeupArtistBloc, MakeupArtistState>(
      builder: (context, state) {
         ...
         makeupArtist=state.selectedMakeupArtist;
        return  makeupArtist != null ?  SafeArea(
          child: Scaffold(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(makeupArtist!.makeupArtistImages!.isNotEmpty
                                ? makeupArtist!.makeupArtistImages!
                            ...
                            Container(
                              ...
                              child: Text(
                                hasData(makeupArtist!.makeupArtistTitle)
                            ...
                            Padding(
                              ...
                              child: Text(hasData(makeupArtist!.makeupArtistLocation)
                                  ? "lbl_location".tr+ " : " + makeupArtist!.makeupArtistLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(makeupArtist!.makeupArtistTitle)
                                  ? makeupArtist!.makeupArtistPrice!
                                  : "0.0"} L.E",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Container(
                              ...
                              child: Text(hasData(makeupArtist!.makeupArtistDescription)
