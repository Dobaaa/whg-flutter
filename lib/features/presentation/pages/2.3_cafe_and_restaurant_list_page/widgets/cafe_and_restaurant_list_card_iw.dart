...
class CafeAndRestaurantListCardIW extends StatelessWidget {
  CafeAndRestaurantListCardIW(this.cafeAndRestaurant, {super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context
            .read<CafeAndRestaurantBloc>()
            .add(OpenCafeAndRestaurantDetailsEvent(cafeAndRestaurant));
        NavigationX.pushNamed(
          CafeAndRestaurantDetailsPageScreen.id,
        );
      },
      child: Container(
        height: 290.v,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                hasData(cafeAndRestaurant.cafeAndRestaurantDescription)
                              ...
                              Row(
                                children: [
                                  Text(
                                    hasData(cafeAndRestaurant.cafeAndRestaurantPrice)
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          // width: 23.h,
                                          child: Text(
                                            hasData(cafeAndRestaurant.cafeAndRestaurantRating)
                                                ? cafeAndRestaurant.cafeAndRestaurantRating!
                                                : "5.0",
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                      ...
                      children: [
                        ...
                        Opacity(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              hasData(cafeAndRestaurant.cafeAndRestaurantLocation)
