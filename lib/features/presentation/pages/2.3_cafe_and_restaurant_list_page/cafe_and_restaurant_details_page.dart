...
class CafeAndRestaurantDetailsPageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CafeAndRestaurantBloc, CafeAndRestaurantState>(
      builder: (context, state) {
         ...
         cafeAndRestaurant=state.selectedCafeAndRestaurant;
        return  cafeAndRestaurant != null ?  SafeArea(
          child: Scaffold(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(cafeAndRestaurant!.cafeAndRestaurantImages!.isNotEmpty
                                ? cafeAndRestaurant!.cafeAndRestaurantImages!
                            ...
                            Container(
                              ...
                              child: Text(
                                hasData(cafeAndRestaurant!.cafeAndRestaurantTitle)
                            ...
                            Padding(
                              ...
                              child: Text(hasData(cafeAndRestaurant!.cafeAndRestaurantLocation)
                                  ? "lbl_location".tr+ " : " + cafeAndRestaurant!.cafeAndRestaurantLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(cafeAndRestaurant!.cafeAndRestaurantTitle)
                                  ? cafeAndRestaurant!.cafeAndRestaurantPrice!
                                  : "0.0"} L.E",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Container(
                              ...
                              child: Text(hasData(cafeAndRestaurant!.cafeAndRestaurantDescription)
