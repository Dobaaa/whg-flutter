...
class DressesDetailsPageScreen extends StatelessWidget {
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(dress!.dressImages!.isNotEmpty
                                ? dress!.dressImages!
                            ...
                            Padding(
                              ...
                              child: Text(hasData(dress!.dressLocation)
                                  ? "lbl_location".tr+ " : " + dress!.dressLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(dress!.dressTitle)
                                  ? dress!.dressPrice!
                                  : "0.0"} L.E",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Container(
                              ...
                              child: Text(hasData(dress!.dressDescription)
