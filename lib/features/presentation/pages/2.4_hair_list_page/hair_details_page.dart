...
class HairDetailsPageScreen extends StatelessWidget {
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(hair!.hairImages!.isNotEmpty
                                ? hair!.hairImages!
                            ...
                            Padding(
                              ...
                              child: Text(hasData(hair!.hairLocation)
                                  ? "lbl_location".tr+ " : " + hair!.hairLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(hair!.hairTitle)
                                  ? hair!.hairPrice!
                                  : "0.0"} L.E",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Container(
                              ...
                              child: Text(hasData(hair!.hairDescription)
