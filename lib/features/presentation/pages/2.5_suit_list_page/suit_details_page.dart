...
class SuitDetailsPageScreen extends StatelessWidget {
  static const String id = 'suit_details_page';

  SuitDetailsPageScreen({this.suit,super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SuitBloc, SuitState>(
      builder: (context, state) {
         print("9999.1 ${state.selectedSuit.suitTitle}");
         suit=state.selectedSuit;
        return  suit != null ?  SafeArea(
          child: Scaffold(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(suit!.suitImages!.isNotEmpty
                                ? suit!.suitImages!
                                : [ImageAsset.imageNotFound]),
                            // CustomImageView(
                            //   imagePath:hall!.suitImages!.isNotEmpty
                            //       ? hall!.suitImages![0]
                            //       : ImageAsset.imageNotFound,
                            //   height: 233.v,
                            //   width: 290.h,
                            ...
                            Padding(
                              ...
                              child: Text(hasData(suit!.suitLocation)
                                  ? "lbl_location".tr+ " : " + suit!.suitLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(suit!.suitTitle)
                                  ? suit!.suitPrice!
                                  : "0.0"} L.E",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Container(
                              ...
                              child: Text(hasData(suit!.suitDescription)
                                  ? suit!.suitDescription!
                                  : "No Description",
                                maxLines: null,
                                textAlign: TextAlign.left,
