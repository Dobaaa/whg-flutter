...
class SuitListCardIW extends StatelessWidget {
  SuitListCardIW(this.suit, {super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.read<SuitBloc>().add(OpenSuitDetailsEvent(suit));
        NavigationX.pushNamed(SuitDetailsPageScreen.id,);
        },
      child: Container(
        height: 290.v,
        width: 396.h,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          CustomImageView(
                            imagePath: suit.suitImages!.isNotEmpty
                                ? suit.suitImages![0]
                                ...
                                Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          // width: 23.h,
                                          child: Text(hasData(suit.suitRating)?
                                          suit.suitRating! : "5.0",
