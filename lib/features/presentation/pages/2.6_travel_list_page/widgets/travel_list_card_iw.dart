...
class TravelListCardIW extends StatelessWidget {
  TravelListCardIW(this.travel, {super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.read<TravelBloc>().add(OpenTravelDetailsEvent(travel));
        NavigationX.pushNamed(TravelDetailsPageScreen.id,);
        },
      child: Container(
        height: 290.v,
        width: 396.h,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                hasData(travel.travelDescription)
                              ...
                              Row(
                                children: [
                                  Text(hasData(travel.travelPrice)?
                                    travel.travelPrice! : "0.0",
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style:
                                ...
                                Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          // width: 23.h,
                                          child: Text(hasData(travel.travelRating)?
                                          travel.travelRating! : "5.0",
