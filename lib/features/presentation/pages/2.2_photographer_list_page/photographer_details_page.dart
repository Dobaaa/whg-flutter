...
class PhotographerDetailsPageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<PhotographerBloc, PhotographerState>(
      builder: (context, state) {
         ...
         photographer=state.selectedPhotographer;
        return  photographer != null ?  SafeArea(
          child: Scaffold(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SliderImage(photographer!.photographerImages!.isNotEmpty
                            ...
                            Padding(
                              ...
                              child: Text(hasData(photographer!.photographerLocation)
                                  ? "lbl_location".tr+ " : " + photographer!.photographerLocation!
                            ...
                            Padding(
                              ...
                              child: Text("${hasData(photographer!.photographerTitle)
                            ...
                            Container(
                              ...
                              child: Text(hasData(photographer!.photographerDescription)
