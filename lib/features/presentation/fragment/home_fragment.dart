...
import 'package:wahg_v1/features/presentation/pages/4_drawer_menu/drawer_menu_Page.dart';
...
import 'package:wahg_v1/features/presentation/ui_componants/hp_recommended_iw.dart';
...
class HomeFragmentState extends State<HomeFragment> {
  ...
  List<HPRecommendedIM> recommendedL = getHPRecommended();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 6.v),
                        _buildRecommendedForSection(context),
                        SizedBox(height: 6.v),
                        CustomImageView(
                          imagePath: ImageAsset.imgOffers1,
                          height: 100.v,
  ...
  Widget _buildJobsApplySection(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // TODO Navigate to Apply page or Google Form link
      },
      child: Align(
        alignment: Alignment.center,
        child: SizedBox(
  ...
  Widget _buildHallsSection(BuildContext context) {
    return BlocBuilder<HallsBloc, HallsState>(
      builder: (context, state) {
        ...
        return state.requestState == RequestState.loading? const GFLoader(
  ...
  Widget _buildRecommendedForSection(BuildContext context) {
    return SizedBox(
      height: 310.v,
      child: ListView.separated(
        padding: EdgeInsets.only(left: 12.h),
        ...
        itemCount: recommendedL.length,
        itemBuilder: (context, index) {
          HPRecommendedIM item = recommendedL[index];
          return HPRecommendedIW(
            item,
          );
        },
      ),
